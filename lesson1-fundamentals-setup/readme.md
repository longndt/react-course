...
### 3. TSX Syntax & Components

**TSX Basics:**
- JSX vs TSX differences
...
- Return statements
- Multi-line TSX with parentheses
...
- [ ] Completed Lesson 0 (TypeScript basics)
...
- **TSX combines TypeScript and JSX** for type-safe component development
...
- **Cause:** Using JSX in .js file instead of .jsx or .tsx
- **Solution:** Rename file to .tsx or ensure Babel/Vite is configured
...
- **Cause:** Component not imported/rendered in App.tsx
