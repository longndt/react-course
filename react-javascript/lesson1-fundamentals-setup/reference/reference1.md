...
### Create New React + JavaScript Project
...
**Key concepts:**
- `function App()` - This is a component (like a JavaScript function)
- `return (...)` - Returns JSX (looks like HTML)
- `<div>`, `<h1>` - JSX elements (similar to HTML tags)
...
**Use in `src/components/Welcome.jsx`:**
```jsx
import './Welcome.css';
...
**src/App.jsx** - A simple landing page:
      ...
      <main>
        <section>
          ...
          <p>
            ...
            It demonstrates basic component structure and JSX syntax.
          </p>
        </section>
